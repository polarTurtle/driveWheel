...
void testing() {
	RectangularPrism rectangle = RectangularPrism(10, 10, 10, 5, 5, 5);
	rectangle.setColor(1, 1, 0);
	rectangle.draw();

	TriangularPrism triangle = TriangularPrism(-10, -10, -10, 5, 2.5, 5, 0.5);
	triangle.setColor(1, 0, 1);
	triangle.draw();

	TrapezoidalPrism trapezoid = TrapezoidalPrism(10, -10, 10, 10, 10, 3, 3, 3);
	trapezoid.setColor(0, 1, 1);
	trapezoid.draw();

	Cylinder circle = Cylinder(10, 10, -10, 5, 10);
